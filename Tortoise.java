...
public class Tortoise extends Racer
{
    ...
    public void morph(Graphics g) {
        ...
        // Tortoise trapped in jail
        g.setColor(Color.DARK_GRAY);
        g.fillRect(startX - 35, startY - 10, 5, 30); // Left
        g.fillRect(startX - 35 + 45, startY - 10, 5, 30); // Right
        g.fillRect(startX - 35, startY - 10, 50, 5); // Top
        g.fillRect(startX - 35, startY - 10 + 25, 50, 5);
